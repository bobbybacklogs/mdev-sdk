 ...
 */
export function estimateCostPer1M(model, inputTokens, outputTokens) {
    if (!model.cost)
        return undefined;
...
export function compareInputCost(a, b) {
...
export function compareOutputCost(a, b) {
 ...
 */
export function costTiersFor(model, contextSize) {
    if (!model.cost?.tiers)
        return undefined;
...
function compareOptionalCost(a, b) {
